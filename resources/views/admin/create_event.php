...
<div class="max-w-2xl">
    <div class="mb-8">
        ...
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Add New Event</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Fill in the details to add a new event to the calendar.</p>
    </div>
    ...
    <div class="bg-white dark:bg-[#121212] rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 p-8">
        <form action="/radio/<?= ADMIN_SLUG ?>/calendar/create" method="POST" class="space-y-6">
            <div>
                ...
                <input type="text" name="title" required placeholder="e.g. Morning Talk Show"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="type" required
                        ...
                        <option value="program">📻 Radio Program</option>
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Brief description of the event..."
