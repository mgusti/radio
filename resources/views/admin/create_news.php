...
<div class="max-w-3xl">
    <div class="mb-8">
        ...
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Berita</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Buat artikel berita baru untuk ditayangkan di website.</p>
    </div>

    <form action="/<?= ADMIN_SLUG ?>/news/create" method="POST" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-[10px] text-gray-400 mt-1 italic">Boleh dikosongkan kalau upload file</p>
            </div>
            <div>
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Upload File Gambar</label>
                ...
                <div class="flex justify-between mt-1 px-1">
                    <span class="text-[10px] text-gray-400 italic">Maks ukuran: 2MB</span>
                    <span class="text-[10px] text-blue-500 font-bold">Rekomendasi: 1200×800px</span>
                </div>
            </div>
        </div>
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" class="bg-black dark:bg-white dark:text-black text-white px-8 py-3 rounded-xl font-semibold hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors shadow-sm flex items-center gap-2">
                <i class="bi bi-send"></i> Simpan & Terbitkan
            </button>
