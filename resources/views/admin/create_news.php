    ...
    <main class="max-w-3xl mx-auto p-6 mt-6">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-gray-500 mt-1">Publish a new article to the site.</p>
            </div>
        </div>

        <form action="/radio/<?= ADMIN_SLUG ?>/news/create" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col gap-6">
            <div>
            ...
            <div>
                ...
                <textarea name="excerpt" rows="2" required 
                          class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all bg-gray-50 focus:bg-white"></textarea>
            </div>
